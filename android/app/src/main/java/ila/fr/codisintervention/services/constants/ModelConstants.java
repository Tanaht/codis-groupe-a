...
public class ModelConstants {
    ...
    public static final String ACTION_INITIALIZE_APPLICATION = "initialize-application";
    ...
    public static final String ACTION_UPDATE_INTERVENTION_CREATE_SYMBOL = "update-intervention-create-symbol";

    public static final String ACTION_ADD_DEMANDE = "add-demande";
    public static final String ACTION_VALIDATION_MOYEN = "validation-moyen";

    public static final String ACTION_ADD_PHOTO = "add-photo";
    public static final String ACTION_UPDATE_DRONE_POSITION = "update-drone-position";
}
